...
export default function ForecastRow({
  ...
  return (
    <div className="p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-4 hover:bg-gray-750 transition-colors">
      ...
      <div className="flex-1 text-right">
        <span className="text-2xl" aria-label={condition}>
          {icon}
        </span>
      </div>
    </div>
